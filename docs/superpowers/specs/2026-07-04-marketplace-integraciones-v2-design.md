...
**Mockups aprobados** (en `.superpowers/brainstorm/12042-1780522210/content/`, gitignoreado): `marketplace-shell-v3.html`, `detail.html`, `oauth-flow.html`, `slack-view.html`, `jira-view.html`, `github-view.html`, `notion-view.html`.
