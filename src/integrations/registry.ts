...
// gcal (H6) NO usa el panel genérico (sections/detail): MyReposPanel lo renderiza
// con <CalendarPanel>. Igual se registra acá para que `hasAdapter('gcal')` sea true
// y aparezca en el nav "Installed"; el adapter genérico nunca se invoca para gcal.
